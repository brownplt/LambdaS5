...
#(cat ses/es-lab-tests/initSESPlus.js; echo "cajaVM.eval(\"___takeS5Snapshot();\");") | ./s5 stdin -count-nodes -opt-const-propagation -count-nodes --eval-s5 -save seseval.heap
